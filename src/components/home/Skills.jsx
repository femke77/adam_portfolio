...
const skills = [
  ...
  { title: "CSS3", src: cssLogo, alt: "CSS Logo" },
...
export default function Skills() {
  ...
  return (
    <Box sx={{marginBottom: "50px"}}>
      <Typography
        variant="h2"
        sx={{ textAlign: "center", marginBottom: "50px", marginTop: "50px" }}
      >
        Skills
      </Typography>
      <Box
        id="skills"
        ref={wrapperRef}
        style={{ overflow: "hidden", whiteSpace: "nowrap", marginTop: "25px", backgroundColor: "white", borderRadius: "10px" }} 
        onMouseEnter={() => {
          loop.paused(true);
        }}
        onMouseLeave={() => {
